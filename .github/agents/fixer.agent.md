...
description: "Applies one reviewer finding (BLOCKER or SHOULD-FIX) or fixes one named test / gate failure in the Vinta Schedule API codebase. Smallest correct change. Re-runs the inner loop + outer gate. Reports. Like the implementer: never branches, pushes, or opens PRs. Never writes AI co-author trailers."
