"""Transitional re-export of ``vinta_billing.services.payment_adapters.mercadopago_payment_adapter``.
...
from vinta_billing.services.payment_adapters.mercadopago_payment_adapter import *  # noqa: F403
