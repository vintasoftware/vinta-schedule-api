"""Transitional re-export of ``vinta_billing.services.subscription_plan_factory.billing_plan_factory``.
...
from vinta_billing.services.subscription_plan_factory.billing_plan_factory import *  # noqa: F403
