"""Transitional re-export of ``vinta_billing.services.subscription_adapters.mercadopago_subscription_adapter``.
...
from vinta_billing.services.subscription_adapters.mercadopago_subscription_adapter import *  # noqa: F403
