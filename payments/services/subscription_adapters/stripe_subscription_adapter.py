"""Transitional re-export of ``vinta_billing.services.subscription_adapters.stripe_subscription_adapter``.
...
from vinta_billing.services.subscription_adapters.stripe_subscription_adapter import *  # noqa: F403
