...
Project skills available: plan-feature, create-spec, create-qa-use-cases, open-pr-from-context, implement-plan, amend-plan, add-env-var, add-one-off-script, add-model, add-migration, run-one-off-script-django
