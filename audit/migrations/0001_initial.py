# Generated by Django 6.0.5 on 2026-06-19 21:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.ForeignObject(editable=False, from_fields=['membership_fk', 'organization_id'], on_delete=django.db.models.deletion.CASCADE, related_name='audit_affected_links', to='organizations.organizationmembership', to_fields=['id', 'organization_id'])),
                ('membership_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_affected_links_fk_rel', to='organizations.organizationmembership')),
                ('organization', models.ForeignKey(help_text='The organization this model is associated with. Queries should use the `organization` field.', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='organizations.organization')),
            ],
        ),
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='+', through='audit.AuditAffectedMembership', through_fields=('audit_fk', 'membership_fk'), to='organizations.organizationmembership'),
        ),
        migrations.AddIndex(
            model_name='auditaffectedmembership',
            index=models.Index(fields=['organization', 'membership_fk'], name='audit_audit_organiz_6c52ad_idx'),
        ),
        migrations.AddConstraint(
            model_name='auditaffectedmembership',
            constraint=models.UniqueConstraint(fields=('organization', 'audit_fk', 'membership_fk'), name='uniq_audit_membership'),
        ),
        migrations.AddIndex(
            model_name='audit',
