...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['membership_fk'], name='audit_audit_members_67bcad_idx'),
        ),
        migrations.AddConstraint(
            model_name='auditaffectedmembership',
            constraint=models.UniqueConstraint(fields=('audit_fk', 'membership_fk'), name='uniq_audit_membership'),
        ),
        migrations.AddIndex(
            model_name='audit',
        ...
        migrations.AddIndex(
            model_name='audit',
            index=models.Index(fields=['action', 'created_at'], name='audit_audit_action_8b107c_idx'),
        ),
        migrations.AddIndex(
            model_name='audit',
            index=models.Index(fields=['actor_type', 'actor_id'], name='audit_audit_actor_t_53ac28_idx'),
        ),
        migrations.AddIndex(
            model_name='audit',
            index=models.Index(fields=['subject_type', 'subject_id'], name='audit_audit_subject_a354dd_idx'),
        ),
    ]
