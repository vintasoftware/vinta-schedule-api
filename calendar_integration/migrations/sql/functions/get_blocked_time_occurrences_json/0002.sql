DROP FUNCTION IF EXISTS get_blocked_time_occurrences_json(BIGINT, TIMESTAMPTZ, TIMESTAMPTZ, INTEGER);
...
BEGIN
    ...
    FOR occurrence_row IN 
        ...
        FROM calculate_recurring_blocked_times(p_blocked_time_id, p_start_date, p_end_date, p_max_occurrences, p_overlap)
