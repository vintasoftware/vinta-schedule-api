DROP FUNCTION IF EXISTS get_event_occurrences_json(BIGINT, TIMESTAMPTZ, TIMESTAMPTZ, INTEGER);
...
BEGIN
    ...
    FOR occurrence_row IN 
        SELECT 
            ...
            exception_type,
            modified_event_id
        FROM calculate_recurring_events(p_event_id, p_start_date, p_end_date, p_max_occurrences, p_overlap)
