...
-- calendar inside one AppointmentTypeSlot, returned as a JSON-per-element TEXT
...
CREATE OR REPLACE FUNCTION get_appointment_type_quota_period_counts_json(
...
BEGIN
    FOR bucket_row IN
        ...
        FROM calculate_appointment_type_quota_period_counts(
            p_calendar_id,
            p_appointment_type_slot_id,
            p_organization_id,
            p_period_type,
            p_week_start,
            p_range_start,
