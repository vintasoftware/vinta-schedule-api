...
-- per-period counts of LIVE bookings made THROUGH that appointment type slot within a
-- search window.
--
-- "Made through the appointment type": the booking has a CalendarEventAppointmentTypeSelection row
...
--
-- "Live": the CalendarEvent row still exists. Cancelling an appointment-type booking
-- deletes the CalendarEvent (see AppointmentTypeService.cancel_appointment_type_event),
