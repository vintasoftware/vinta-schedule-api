...
**Phase 3b — Opaque public slug for codeless group booking** — not started. NEW phase, added mid-run; see the blocking follow-up under Phase 3.

## Remaining phases

| Phase | Title | Impl tier | Reviewer tier |
|---|---|---|---|
| 3b | Opaque public slug for codeless group booking | 3 | 4 |
