...
|---|---|---|---|---|---|---|---|
| 0 | Bind the organization at every unscoped call site | 3 | reviewer 4 | ⏳ pending | — | `plan-vinta-django-orgs-migration` | — |
...
Phase 0 — not yet started; awaiting the user's go at the worktree confirmation gate.
