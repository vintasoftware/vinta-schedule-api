...
from tenancy.branding_logo import sign_branding_logo_upload
...
from tenancy.notification_contexts import (
...
class TestValidateRedirectUrl:
    """Unit tests for ``tenancy.redirect_url_validation.validate_redirect_url``.
...
class TestEvaluateBrandingWriteGate:
    """``tenancy.permissions.evaluate_branding_write_gate`` -- the full
...
class TestSignBrandingLogoUpload:
    """``tenancy.branding_logo.sign_branding_logo_upload`` -- the ``branding_logos``
