...
from tenancy.exceptions import InvalidInvitationTokenError
...
class TestOrganizationViewSet:
    ...
    @patch("tenancy.views.OrganizationViewSet.get_queryset")
    @patch("tenancy.services.OrganizationService.create_organization")
...
class TestOrganizationPermissions:
    ...
    def test_organization_permission_without_membership(
        ...
        url = reverse("api:Organizations-list")
        with patch("tenancy.views.OrganizationViewSet.get_queryset") as mock_get_queryset:
...
class TestOrganizationInvitationViewSet:
    ...
    @patch("tenancy.services.OrganizationService.revoke_invitation")
    ...
    @patch("tenancy.services.OrganizationService.invite_user_to_organization")
...
class TestAcceptInvitationView:
    ...
    @patch("tenancy.services.OrganizationService.accept_invitation")
...
class TestSyncRoomsAction:
    ...
    @patch("tenancy.services.OrganizationService.request_rooms_sync")
...
class TestPhase20SyncAllCalendars:
    ...
    @patch("tenancy.services.OrganizationService.request_all_calendars_sync")
