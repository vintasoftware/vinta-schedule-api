...
class TestOrganizationService:
    ...
    def test_invite_user_to_organization_new_invitation(
        ...
        with patch("tenancy.services.transaction.on_commit") as mock_on_commit:
            mock_on_commit.side_effect = lambda func: func()

            # Mock the NotificationContextDict to avoid the tuple issue
            with patch("tenancy.services.NotificationContextDict") as mock_context_dict:
    ...
    def test_accept_invitation_valid_token(self, organization_service, user, organization):
        ...
        from tenancy.models import OrganizationInvitation, OrganizationMembership
    ...
    def test_invite_user_to_organization_second_call_resets_not_duplicates(
        ...
        with (
            patch("tenancy.services.transaction.on_commit") as mock_on_commit,
            patch("tenancy.services.NotificationContextDict"),
        ):
            mock_on_commit.side_effect = lambda func: func()
