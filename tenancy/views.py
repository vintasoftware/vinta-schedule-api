...
class OrganizationBrandingView(TenantScopedViewMixin, views.APIView):
    ...
    (``tenancy.permissions.evaluate_branding_write_gate``), AND the
    ...
    ``PermissionDenied`` subclass (``tenancy.exceptions``) so the
    ...
    (``tenancy.permissions.is_branding_eligible_organization`` --
    ...
    def _check_branding_read_gate(self) -> None:
        ...
        **eligibility** gate (parentless, entitled) used for GET.
        ...
        Delegates to ``tenancy.permissions.check_branding_read_eligibility``,
...
class OrganizationBrandingLogoUploadParamsView(TenantScopedViewMixin, views.APIView):
    ...
    (``tenancy.permissions.check_branding_read_eligibility`` -- parentless
...
class OrganizationLogoDeliveryView(views.APIView):
    ...
    S3 URLs (``tenancy.branding_logo.signed_logo_url``), which change with
