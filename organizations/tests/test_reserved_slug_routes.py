...
present in :data:`organizations.slug_validation.RESERVED_ORGANIZATION_SLUGS`. A new
...
from organizations.slug_validation import RESERVED_ORGANIZATION_SLUGS
...
class TestReservedSlugRoutesSync:
    ...
    def test_every_top_level_route_segment_is_reserved(self):
        ...
        assert not unreserved, (
            ...
            "organizations.slug_validation's reserved-slug set: "
